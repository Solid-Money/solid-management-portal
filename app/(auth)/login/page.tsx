...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // Optional: Hint to only show accounts from the workspace domain
      provider.setCustomParameters({
        hd: getAllowedDomain(),
      });
      console.log('[Login] Provider configured with domain:', getAllowedDomain());
      
      console.log('[Login] Opening Google sign-in popup...');
      ...
      // The AuthProvider will handle redirect after successful authentication
    } catch (err) {
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Sign in with your @{getAllowedDomain()} account
          </p>
        </div>
